...
root_folder_path = r'app\core\agents\langgraph\simple_agent'  # Replace with the actual root folder path

# Output .txt file path
output_file = 'simple.txt'  # Replace with desired output file location
